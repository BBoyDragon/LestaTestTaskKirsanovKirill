...
from Task2.Buffers.CycleBufferLinkedList import CycleBufferLinkedList


class TestCycleBufferLinkedList(unittest.TestCase):
    def setUp(self):
        self.buffer = CycleBufferLinkedList(3)
